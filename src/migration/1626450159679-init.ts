...
export class init1626450159679 implements MigrationInterface {
    name = 'init1626450159679'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "refresh_token" ("token" uuid NOT NULL DEFAULT uuid_generate_v4(), "expiryDate" TIMESTAMP NOT NULL, "userId" integer, CONSTRAINT "PK_c31d0a2f38e6e99110df62ab0af" PRIMARY KEY ("token"))`);
        ...
        await queryRunner.query(`CREATE TABLE "script" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "innerHtml" character varying NOT NULL, "authorId" integer NOT NULL, CONSTRAINT "PK_90683f80965555e177a0e7346af" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "script" ADD CONSTRAINT "FK_2632c16179d3ec47688d979825b" FOREIGN KEY ("authorId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "script" DROP CONSTRAINT "FK_2632c16179d3ec47688d979825b"`);
